...
export function PricingSection() {
    ...
    const paidPlans = pricing.pricingItems.slice(0, 2);

    const freePlan = pricing.pricingItems[2];
                    ...
                    <div className="col-span-2 flex flex-col gap-4 p-8 md:p-14">
                        <div className="space-y-4">
                            ...
                            <p className="text-balance text-muted-foreground">
                                vibe-check is MIT licensed and will always be free. Choose your install method.
                            </p>
                        </div>
                    </div>
